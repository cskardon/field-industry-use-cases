...
The Identification of Medicinal Products (IDMP) is a system for identifying and tracking medicinal products. It is a global system that is used to identify and track medicinal products across the world.

* xref:life-sciences/medical-care/idmp.adoc[Identification of Medicinal Products (IDMP)]
